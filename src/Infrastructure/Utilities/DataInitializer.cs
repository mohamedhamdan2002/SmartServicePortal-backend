...
public static class DataInitializer
{
    ...
    private static IEnumerable<T>? GetDataFromFile<T>(string path) where T : Entity
    {
        if (!File.Exists(path))
    ...
    private static async Task SetData<T>(AppDbContext dbContext, string path) where T : Entity
    {
